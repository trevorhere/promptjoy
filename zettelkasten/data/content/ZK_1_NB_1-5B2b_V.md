...
## 1,5B2b Anders als bei [Hobbes](/bestand/register/personenregister/item/hobbes_thomas) fordert die Vernunft des 
 ...
 his liberty, and his property (for no rational creature 
 can be supposed to extend change his condition with an 
 intention to be worse), the power of the society, or [[Fortsetzung des Textes auf Zettel 1-5B2c|]]

---
## Navigation

- **Forward in branch**: [[1-5B2c|ZK I Zettel 1,5B2c]]
...
---
## Metadata
- **EKIN**: `ZK_1_NB_1-5B2b_V`
- **Image ID**: `ZK_1_01_01_093_V_N_NB_1-5B2b`
- **Availability**: free
- [View in Archive](https://niklas-luhmann-archiv.de/bestand/zettelkasten/zettel/ZK_1_NB_1-5B2b_V)
