...
## 1,6e1 the unifying relation. The tendency to personify 
 groups, ships, storms, debates, and everything else 
 is as old as human thought and is in some 
 measure unavoidable. For we must always depend 
 on analogies, and personal analogies give our language 
...
- **Forward in branch**: [[1-6e2|ZK I Zettel 1,6e2]]
- **Next complex**: [[1-8|ZK I Zettel 1,8]]
- **Previous complex**: [[1-5|ZK I Zettel 1,5]]

---
## Metadata
- **EKIN**: `ZK_1_NB_1-6e1_V`
- **Image ID**: `ZK_1_01_02_033_V_N_NB_1-6e1`
- **Availability**: free
- [View in Archive](https://niklas-luhmann-archiv.de/bestand/zettelkasten/zettel/ZK_1_NB_1-6e1_V)
