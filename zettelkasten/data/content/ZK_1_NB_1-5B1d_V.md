...
## 1,5B1d 
 ...
 particular. For it is the Unity of the Representer, 
 not the Unity of the Represented, that maketh 
 the Person One . And it is the Representer that 
 beareth the person, and but one person: and 
...
- **Forward in branch**: [[1-5B1e|ZK I Zettel 1,5B1e]]
- **Supplementary branch**: [[1-5B1d1|ZK I Zettel 1,5B1d1]]
- **Back to parent**: [[1-5|ZK I Zettel 1,5]]
- **Next complex**: [[1-6|ZK I Zettel 1,6]]
- **Previous complex**: [[1-3|ZK I Zettel 1,3]]

---
## Metadata
- **EKIN**: `ZK_1_NB_1-5B1d_V`
- **Image ID**: `ZK_1_01_01_083_V_N_NB_1-5B1d`
- **Availability**: free
- [View in Archive](https://niklas-luhmann-archiv.de/bestand/zettelkasten/zettel/ZK_1_NB_1-5B1d_V)
